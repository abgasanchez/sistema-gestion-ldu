  ...
  function lduGoToModuleFilter108_(target, value, selector) {
    ...
    var tries = 0, timer = setInterval(function () {
      ...
      if (sel && sel.value !== value) {
        var match = Array.prototype.find.call(sel.options || [], function (o) { return o.value === value; });
        if (match) { sel.value = value; sel.dispatchEvent(new Event('input')); sel.dispatchEvent(new Event('change')); }
      }
