...
(function () {
  ...
  function buildResumenDashboardSheet_(incidents, t) {
    ...
    ws['!cols'] = [{ wch: 32 }, { wch: 18 }, { wch: 14 }, { wch: 12 }, { wch: 12 }, { wch: 12 }, { wch: 12 }, { wch: 12 }, { wch: 12 }, { wch: 12 }, { wch: 12 }];
    ws['!merges'] = [{ s: { r: 0, c: 0 }, e: { r: 0, c: 3 } }, { s: { r: 3, c: 0 }, e: { r: 3, c: 3 } }, { s: { r: 19, c: 0 }, e: { r: 19, c: 3 } }];
    return ws;
  }
