...
(function () {
  ...
  window.renderHistory = renderHistory = async function () {
    ...
    try {
      ...
      const fields = ['fecha','accion','usuario','imei','marca','modelo','n_linea','responsable','dni','cargo','tipo','modalidad','supervisor','zona','cuenta','departamento','ciudad','canal','tienda','tipo_uso','fecha_asignacion','monto','estado','doc_autorizacion','documentos_adjuntos','observaciones'];
