...
(function () {
  ...
  const appObserver = new MutationObserver(installNotificationPreview); appObserver.observe(document.querySelector('#app'), { childList: true, subtree: true }); installNotificationPreview();
})();
