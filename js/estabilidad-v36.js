...
(function () {
  ...
  window.renderSettings = renderSettings = function () {
    ...
    document.querySelector('#v36-sync-novivo').onclick = function () { api('syncImeiNoVivo').then(function (r) { alert(r.message || 'IMEI NO VIVO sincronizado.'); }).catch(function (e) { alert(e.message); }); };
